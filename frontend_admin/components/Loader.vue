...
#spinner #sGD stop {
    stop-color: var(--tw-color-primary);
}
    ...
    <div>
        <div class="">
            <svg version="1.1" viewBox="0 0 64 64" width="1em" xmlns="http://www.w3.org/2000/svg" id="spinner">
                ...
                <path class="path-solid" d="M 32,4 A 28 28,0,0,0,32,60" fill="none" stroke="#FF66C4" stroke-width="8"
                    stroke-linecap="round" />

                <defs>
                    <linearGradient id="sGD" gradientUnits="userSpaceOnUse" x1="32" y1="0" x2="32" y2="64">
                        <stop offset="0.1" stop-opacity="0" class="stop1"></stop>
                        <stop offset=".9" stop-opacity="1" class="stop2"></stop>
                    </linearGradient>
                </defs>
